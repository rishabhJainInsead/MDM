...
def stepEight():
    print_red("\n---------------------------------")
    print("""
\nIt's time for step 8: Planning for improbable uncertainties is like carrying an umbrella in a desert, it may seem ridiculous, but you never know when a spontaneous rain dance party might break out.""")
