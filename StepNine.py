...
def stepNine():
    print_red("\n---------------------------------")
    print("""
\nIt's time for step 9: 
We know that the ability for a swallow to carry 
a one-pound coconut depends on whether it 
is a European or an African swallow, 
but how many black swans are needed? 
Time for step 9: consider your coconuts and black swans.""")
